...
function drawEx0() {
    ...
    if (canvas.getContext) {
        ...
        ctx.fillStyle = "rgba(75, 245, 123, 0.81)"; // Color verde claro
        // Dibuja en 150,150. (Por eso el canvas mide 300x300)
        ctx.fillRect(150, 150, 100, 100);
    }
}

// ---------------------------------------------------------
// EJEMPLOS TUTORIAL CANVAS
// ---------------------------------------------------------
...
// 8. Combinación (Pacman/Personajes)
function drawEx8() {
